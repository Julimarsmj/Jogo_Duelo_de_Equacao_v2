CREATE DATABASE  IF NOT EXISTS `dbjogador` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dbjogador`;
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: dbjogador
-- ------------------------------------------------------
...
CREATE TABLE `tbjogador` (
  ...
  `niveljogo` varchar(15) DEFAULT NULL,
  `avatar` longblob,
...
-- Dump completed on 2026-02-05 23:04:11
